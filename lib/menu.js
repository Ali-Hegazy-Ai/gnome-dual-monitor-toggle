...
export function buildMonitorMenu(toggle) {
    ...
    for (const monitor of toggle._monitors) {
        ...
        item.connect('activate', async () => {
            ...
            toggle._writeSavedMonitorSetting(toggle._monitor);
    ...
    let tempInfoBox = new St.BoxLayout({ orientation: Clutter.Orientation.VERTICAL, style_class: 'monitor-info-box'});
    ...
    let persistentInfoBox = new St.BoxLayout({ orientation: Clutter.Orientation.VERTICAL, style_class: 'monitor-info-box'});
